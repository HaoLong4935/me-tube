                    ...
                    {!isLoading && (
                        <CarouselItem
                            ...
                            <Badge
                                ...
                                className=" rounded-lg px-3 py-1 cursor-pointer whitespace-nowrap text-sm text-slate-500">
                                All
                            </Badge>
                        </CarouselItem>
                    )}
                    ...
                    {!isLoading && data.map((item) => (
                        ...
                        >
                            <Badge
                                ...
                                className="text-slate-500 hover:text-blue-500 hover:bg-slate-200 cursor-pointer rounded-lg px-3 py-1 whitespace-nowrap text-sm">
                                {item.label}
                            </Badge>
                        </CarouselItem>
                    ))}
