        ...
        <div>
            ...
            <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group/drop">
                <div slot="heading" className="flex flex-col items-center gap-6">
                    <div className="flex items-center justify-center gap-2 rounded-full bg-gray-400 h-32 w-32">
                        <UploadIcon className="size-10 text-muted-foreground group/drop-[&[active]]
                    ...
                    <MuxUploaderFileSelect muxUploader={UPLOADER_ID}>
                        <Button type="button" className="bg-black text-white hover:text-black rounded-full">
                            Select files
                        </Button>
