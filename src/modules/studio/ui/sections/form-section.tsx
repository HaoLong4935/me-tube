...
import { CopyCheckIcon, CopyIcon, GlobeIcon, ImagePlusIcon, Loader2Icon, LockIcon, MoreVerticalIcon, RotateCcwIcon, SparkleIcon, TrashIcon } from "lucide-react";
...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const generateDescription = trpc.videos.generateDescription.useMutation({
        onSuccess: () => {
            toast.success("Back ground job started", { description: "Background job started" })
        },
        onError: () => {
            toast.error("Something went wrong")
        }
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-x-2">
                            ...
                            <DropdownMenu >
                                {/* asChild thi DropdownMenu se la con cua Button , neu khong co asChild */}
                                {/* Thi code se hieu la button boc button => Gay loi */}
                                        ...
                                        <div className="flex flex-col gap-y-1">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <Button
                                                    ...
                                                    variant="ghost"
                                                    size="icon"
                                                    className="shrink-0 hover:bg-slate-200 hover:cursor-pointer rounded-full"
                                                    onClick={onCopy}
                                                    disabled={isCopied}
                                                >
